...
public class SubscribeThread extends Thread implements SensorDataListener
{
	...
	public void onDataSensed(SensorData data)
	{
		try
		{
			...
			JSONFormatter formatter = DataFormatter.getJSONFormatter(resultScreen, sensorType);

			logger.log(SensorUtils.getSensorName(sensorType)+"Simple", formatter.toString(data));
